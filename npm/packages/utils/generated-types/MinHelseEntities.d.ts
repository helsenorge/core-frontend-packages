...
export interface GeneralPractitionerTimeavtaleResponse
  extends TimeavtaleResponse {
...
export interface ContactConversationItemResponse
  extends ConversationItemResponse {
...
export interface PrescriptionConversationItemResponse
  extends ConversationItemResponse {
...
export interface SpecialistAppointmentConversationItemResponse
  extends ConversationItemResponse {
...
export interface HelseregisterConversationResponse
  extends ConversationResponse {
...
export interface BytteFastlegeConversationResponse
  extends ConversationResponse {}
export interface OppgaveConversationResponse extends ConversationResponse {}
export interface PrimarhelsetjenesteAppointmentConversationItemResponse
  extends ConversationItemResponse {
  AppointmentStatus: AppointmentStatus;
...
export interface SamtykkeforesporselConversationItemResponse
  extends ConversationItemResponse {
  DefinisjonId: any;
  Svarfrist: ISO8601;
  Paaminnelse: ISO8601;
...
export interface MeldingsformidlingConversationItemResponse
  extends ConversationItemResponse {
  DelInnholdMed: RoleToPatientType;
}
export interface OppgaveConversationItemResponse
  extends ConversationItemResponse {
...
export interface BytteFastlegeConversationItemResponse
  extends ConversationItemResponse {}
export interface HelsefagligKontaktConversationItemResponse
  extends ConversationItemResponse {
  NewHelsefagligKontaktMessageHash: string;
  Counterparty: Person;
  TechnicalCounterparty: SenderOrReceiver;
}
export interface CoordinatorConversationItemResponse
  extends ConversationItemResponse {
  NewCoordinatorMessageHash: string;
...
export interface HelseregisterConversationItemResponse
  extends ConversationItemResponse {
  NewHelseregisterMessageHash: string;
}
export interface GeneralPractitionerAppointmentConversationItemResponse
  extends ConversationItemResponse {
  AppointmentStatus: AppointmentStatus;
  AppointmentDate: string;
  Start: ISO8601;
...
export interface ConsultationConversationItemResponse
  extends ConversationItemResponse {
...
export interface UpdateVarseloppsettCommandResult
  extends MinHelseCommandResult {
...
export interface PrimarhelsetjenesteTimeavtaleResponse
  extends TimeavtaleResponse {
  Subject: string;
  Duration: any;
...
export interface CriticalInformationItem
  extends CriticalInformationVerifiedNone {
  Active: boolean;
  Title: string;
  Status: string;
  Description: string;
...
export interface NationalSpecialistTimeavtaleResponse
  extends TimeavtaleResponse {
  AppointmentId: string;
  AppointmentStatus: AppointmentStatus;
  Subject: string;
...
export interface GetKontaktInformationCommandResult
  extends MinHelseCommandResult {
  Fnr: string;
  Navn: string;
  Adresse: Address;
...
export interface HelsefagligKontaktConversationResponse
  extends ConversationResponse {
  NewHelsefagligKontaktMessageHash: string;
}
export interface PrimarhelsetjenesteAppointmentConversationResponse
  extends AppointmentConversationResponse {
  StartTime: ISO8601;
  EndTime: ISO8601;
  AppointmentStatus: AppointmentStatus;
  AppointmentId: string;
...
export interface GeneralPractionerAppointmentConversationResponse
  extends AppointmentConversationResponse {
  StartTime: ISO8601;
  EndTime: ISO8601;
  AppointmentStatus: AppointmentStatus;
...
export interface CriticalInformationCategorizedItem
  extends CriticalInformationItem {
  SubcategoryCode: string;
}
export interface XContainer extends XNode {}
export interface SpecialistAppointmentConversationResponse
  extends AppointmentConversationResponse {
...
export interface AnestheticComplication
  extends CriticalInformationCategorizedItem {
...
export interface DeviationFromGuidelines
  extends CriticalInformationCategorizedItem {
  ValidTo: ISO8601;
  Specification: string;
}
...
export interface GenererMineRefleksjonerPdfOperationResponse
  extends ClientOperationResponse {
  FileName: string;
  ContentType: string;
  Content: string;
}
export interface GetFeatureTogglesOperationResult
  extends ClientOperationResponse {
  FeatureToggles: any;
}
export interface GetDifiContactInformationOperationResponse
  extends ClientOperationResponse {
  Information: DifiContactInformation;
}
export interface PersistentMessageOperationResponse
  extends ClientOperationResponse {
...
export interface ChangeAppointmentSpecialistOperationResponse
  extends ClientOperationResponse {
...
export interface IsAppointmentOnlineBookableOperationResponse
  extends ClientOperationResponse {
  AppointmentId: string;
  AppointmentVersionId: string;
  OnlineBookable: boolean;
...
export interface IsHelseNordPatientOperationResponse
  extends ClientOperationResponse {
  IsHelseNordPatient: boolean;
}
export interface GetXDSDokumentListeOperationResponse
  extends ClientOperationResponse {
...
export interface GetFeatureToggleOperationResult
  extends ClientOperationResponse {
  IsEnabled: boolean;
}
export interface GetXDSDokumentOperationResponse
  extends ClientOperationResponse {
...
export interface GetPasientJournalRegionOperationResponse
  extends ClientOperationResponse {
  Region: HelseRegion;
}
export interface GetHealthContactsOperationResponse
  extends ClientOperationResponse {
...
export interface GetJournalDocumentListOperationResponse
  extends ClientOperationResponse {
...
export interface GetTilgangsloggAnsattInnsynOperationResponse
  extends ClientOperationResponse {
  AnsattInnsynElementer: any;
  TotaltAntallAnsattInnsyn: number;
}
export interface IsHelseVestPatientOperationResponse
  extends ClientOperationResponse {
  IsHelseVestPatient: boolean;
}
export interface GetInnloggingsDialogInfoOperationResponse
  extends ClientOperationResponse {
  ShowDialog: boolean;
...
export interface GetUnreadMessageCountOperationResponse
  extends ClientOperationResponse {
  MessageCount: number;
  HasUvistVarselmeny: boolean;
}
export interface GetTilgangsloggInnsynOperationResponse
  extends ClientOperationResponse {
  TilgangsloggInnsynElementer: any;
  TotaltAntallInnsyn: number;
  Melding: EkspanderbarMelding;
}
export interface GetSYSVAKLoggOverBrukOperationResponse
  extends ClientOperationResponse {
  Innsyn: Innsyn;
}
export interface SendRegisterInnsynForesporselOperationResponse
  extends ClientOperationResponse {}
export interface GetVarselmenyElementerOperationResponse
  extends ClientOperationResponse {
  VarselmenyElementer: Array<VarselmenyElement>;
}
export interface GetConversationsCountOperationResponse
  extends ClientOperationResponse {
  Count: number;
}
...
export interface GetDocumentListOperationResponse
  extends ClientOperationResponse {
...
export interface GetDokumenterOperationResponse
  extends ClientOperationResponse {
...
export interface UpdateDokumentegenskaperResponse
  extends ClientOperationResponse {}
export interface GetConversationOperationResponse
  extends ClientOperationResponse {
  Items: Array<ConversationItemResponse>;
  Conversation: ConversationResponse;
}
export interface GetConversationsOperationResponse
  extends ClientOperationResponse {
  ConversationThreads: Array<ConversationResponse>;
  SearchWords: any;
}
export interface GetFilteredContactsOperationResponse
  extends ClientOperationResponse {
  FilteredContacts: Array<FilteredContact>;
}
export interface GetSpecialistAppointmentLetterOperationResponse
  extends ClientOperationResponse {
  Items: Array<ConversationItemResponse>;
}
export interface GetDokumentLoggOperationResponse
  extends ClientOperationResponse {
  DokumentDelingBrukListe: Array<DokumentDelingBruk>;
}
export interface HentBehandlerePrimarhelsetjenesteFhirOperationResult
  extends ClientOperationResponse {
  Behandlere: Array<TilgjengeligBehandlerPrimarhelsetjenesteResponse>;
}
export interface FerdigstilleSkjemaOperationResponse
  extends ClientOperationResponse {
  MessageId: string;
}
export interface GetEgenandelerOperationResponse
  extends ClientOperationResponse {
  Egenandeler: EgenandelerResponse;
}
export interface GetAvtaleTilhorighetOperationResponse
  extends ClientOperationResponse {
  AvtaleTilhorighet: AvtaleTilhorighet;
}
export interface GetInitialDataOperationResponse
  extends ClientOperationResponse {
  InitialData: MinHelseInitialData;
  NextReleaseLive: boolean;
}
export interface GetInnbyggersBarnOperationResponse
  extends ClientOperationResponse {
  Response: InnbyggersBarnContainer;
}
export interface RemoveVentelisteOperationResponse
  extends ClientOperationResponse {
  Response: RemoveVentelisteResponse;
}
export interface SetListeTilhorighetOperationResponse
  extends ClientOperationResponse {
  Response: ListeTilhorighetResponse;
}
export interface SetVentelisteOperationResponse
  extends ClientOperationResponse {
  Response: SetVentelisteResponse;
}
export interface DeleteMineRefleksjonerOperationResponse
  extends ClientOperationResponse {
  Deleted: boolean;
}
export interface GetAvtaleDetaljerOperationResponse
  extends ClientOperationResponse {
  AvtaleDetaljer: AvtaleDetaljer;
}
export interface GetMineRefleksjonerOperationResponse
  extends ClientOperationResponse {
  MineRefleksjoner: string;
}
export interface HentSkjemaoppgaveOperationResponse
  extends ClientOperationResponse {
  FormData: Skjema;
...
export interface ClientStreamOperationResponse
  extends ClientOperationResponse {}
export interface ClientXmlOperationResponse extends ClientOperationResponse {
  Content: XElement;
}
export interface CreateTilgangsbegrensningOperationResponse
  extends ClientOperationResponse {
  Tilgangsbegrensning: Tilgangsbegrensning;
}
export interface DeleteTilgangsbegrensningOperationResponse
  extends ClientOperationResponse {
  Tilgangsbegrensning: Tilgangsbegrensning;
}
export interface GetTilgangsbegrensningerOperationResponse
  extends ClientOperationResponse {
  Tilgangsbegrensninger: Array<Tilgangsbegrensning>;
}
export interface GetPersonalInformationOperationResponse
  extends ClientOperationResponse {
  Information: PersonalInformation;
}
export interface SaveMineRefleksjonerOperationResponse
  extends ClientOperationResponse {
  Saved: boolean;
}
...
export interface ChangeVentelisteOperationResponse
  extends ClientOperationResponse {
  Response: SetVentelisteResponse;
}
...
export interface GetSkjemaFraKatalogOperationResponse
  extends ClientOperationResponse {
  FormDefinition: Skjema;
  OpprettetFraLenke: boolean;
}
export interface LagreRenditionAvSkjemaOperationResponse
  extends ClientOperationResponse {
  Rendition: Skjema;
}
...
export interface SaveSkjemaFraKatalogOperationResponse
  extends ClientOperationResponse {
  ConversationId: string;
  Success: boolean;
  ExternalId: string;
...
export interface UploadDokumentSkjemaOperationResponse
  extends ClientOperationResponse {
  DokumentId: string;
  GetArchiveDocumentHash: string;
  DeleteArchiveDocumentHash: string;
}
export interface GetHelsetilbudOperationResponse
  extends ClientOperationResponse {
...
export interface GetHelsetilbudTjenesterOperationResponse
  extends ClientOperationResponse {
...
export interface GetAvailableAppointmentsOperationsResponse
  extends ClientOperationResponse {
...
export interface GetAppointmentDetailsOperationResponse
  extends ClientOperationResponse {
  Appointment: TimeavtaleResponse;
}
export interface GetTimeavtalerOperationResponse
  extends ClientOperationResponse {
  Appointments: Array<TimeavtaleResponse>;
}
export interface HentMotpartInfoOperationResponse
  extends ClientOperationResponse {
  ValidertMotpartSertifikat: boolean;
}
export interface TimeadministrasjonsstotteResponse
  extends ClientOperationResponse {
  CancelAppointmentHash: string;
  MessageFunction: string;
  TransportFormat: TransportFormat;
}
export interface GetKommunaleTjenesterOperationResponse
  extends ClientOperationResponse {
  KommunaleTjenester: Array<KommunalTjeneste>;
  TidligereKommunaleTjenester: Array<KommunalTjeneste>;
}
export interface GetAppointmentTypeOperationResponse
  extends ClientOperationResponse {
  AppointmentType: AppointmentType;
}
export interface GetRegisterInnsynOperationResponse
  extends ClientOperationResponse {
  Innsyn: Innsyn;
  Register: Register;
  Vedlegg: Array<RegisterDokument>;
}
export interface GetSYSVAKInnsynOperationResponse
  extends ClientOperationResponse {
  Innsyn: Innsyn;
}
...
export interface GetSoknaderForPasientOperationResponse
  extends ClientOperationResponse {
...
export interface GetBarnAvPasientOperationResponse
  extends ClientOperationResponse {
  Barn: Array<Barn>;
}
...
export interface SetDokumenterLestOperationResponse
  extends ClientOperationResponse {
  Success: boolean;
}
export interface GetPasientreiserFeaturesOperationResponse
  extends ClientOperationResponse {
  UtvidetSoknadEnabled: boolean;
  KlagerEnabled: boolean;
}
export interface AddBilagToSoknadOperationResponse
  extends ClientOperationResponse {
  Soknad: Soknad;
}
export interface DeleteBilagForKlageOperationResponse
  extends ClientOperationResponse {
  Klage: Klage;
}
export interface GetBilagForslagOperationResponse
  extends ClientOperationResponse {
  Bilag: any;
}
export interface GetBilagSoknadOperationResponse
  extends ClientOperationResponse {
  Bilag: string;
}
export interface SaveBilagForKlageOperationResponse
  extends ClientOperationResponse {
  Klage: Klage;
}
export interface GetMFRLoggOverBrukOperationResponse
  extends ClientOperationResponse {
  Innsyn: Innsyn;
}
export interface ValiderPostnummerOperationResponse
  extends ClientOperationResponse {
  Poststed: string;
  Adresse: AdresseValue;
}
export interface PasientreiserOperationResponse
  extends ClientOperationResponse {}
export interface SearchPersonForFullmaktOperationResponse
  extends ClientOperationResponse {
  Status: GetPersonForFullmaktStatus;
  Fullmaktshaver: Fullmaktshaver;
}
export interface GetFamiliemedlemmerOperationResponse
  extends ClientOperationResponse {
...
export interface GetVarseloppsettOperationResponse
  extends ClientOperationResponse {
  Varseloppsett: GetVarseloppsettCommandResult;
}
export interface UpdateVarseloppsettOperationResponse
  extends ClientOperationResponse {
  Varseloppsett: UpdateVarseloppsettCommandResult;
}
export interface GetTjenesterMedTilgangOperationResponse
  extends ClientOperationResponse {
...
export interface DeleteSamtykkeHelsenorgeOperationResponse
  extends ClientOperationResponse {
  AktiveFullmakter: Array<AktivFullmakt>;
  BarnMedAktivtRegisterinnsynSamtykke: Array<BasisProfil>;
  Slettet: boolean;
}
export interface GetBarnMedForeldreSamtykkeInfoOperationResponse
  extends ClientOperationResponse {
...
export interface UpdateForeldreSamtykkeOperationResult
  extends ClientOperationResponse {}
export interface GetReservasjonerOperationResponse
  extends ClientOperationResponse {
  Reservasjoner: Array<Reservasjon>;
}
export interface GetReservasjonOperationResponse
  extends ClientOperationResponse {
  Reservasjon: Reservasjon;
}
export interface GetRepresentasjonsforholdOperationResponse
  extends ClientOperationResponse {
...
export interface GetPersonvernInnstillingerOperationResult
  extends ClientOperationResponse {
  PersonvernInnstillinger: Array<GeneriskPersonvernInnstilling>;
}
export interface GetHelsetjenesterLoggOperationResponse
  extends ClientOperationResponse {
  Historikk: Array<HelsetjenesterLogg>;
}
export interface CreateFullmaktOperationResponse
  extends ClientOperationResponse {
  FullmaktId: number;
}
export interface GetFullmakterOperationResponse
  extends ClientOperationResponse {
  Fullmakter: Array<Fullmakt>;
}
export interface GetHistoriskeFullmakterOperationResponse
  extends ClientOperationResponse {
  Fullmakter: Array<Fullmakt>;
}
export interface GetTjenesteOmraderOperationResponse
  extends ClientOperationResponse {
  TjenesteOmrader: Array<TjenesteOmrade>;
}
...
export interface GetBehandlingsstederOperationResponse
  extends ClientOperationResponse {
...
export interface SearchAdresserOperationResponse
  extends ClientOperationResponse {
  Adresses: Array<AdresseValue>;
}
export interface AddDonorkortParorendeOperationResponse
  extends ClientOperationResponse {
  Id: string;
}
...
export interface RemoveDonorkortParorendeOperationResponse
  extends ClientOperationResponse {
  Id: string;
}
export interface SendDonorkortParorendeSmsOperationResponse
  extends ClientOperationResponse {}
export interface UpdateDonorkortResponse extends ClientOperationResponse {}
export interface GetKJInnsynssperreOperationResponse
  extends ClientOperationResponse {
...
export interface UpdateKJInnsynssperreOperationResult
  extends ClientOperationResponse {
  Innsynssperre: Innsynssperre;
  BlokkertePersoner: Array<String>;
  InnsynssperreModuler: Array<InnsynssperreModul>;
...
export interface DeleteKJKontaktPersonOperationResponse
  extends ClientOperationResponse {}
export interface GetKJKontaktPersonerOperationResponse
  extends ClientOperationResponse {
  Kontakter: Array<Kontakt>;
  TotaltAntall: number;
  MaksAntall: number;
}
export interface UpdateKJKontaktPersonOperationResponse
  extends ClientOperationResponse {}
export interface GetKommunikasjonsInnstillingerOperationResponse
  extends ClientOperationResponse {
  Kommunikasjon: KommunikasjonsTyper;
}
export interface UpdateKommunikasjonsInnstillingerOperationResponse
  extends ClientOperationResponse {}
export interface GetBesokshistorikkOperationResponse
  extends ClientOperationResponse {
...
export interface GetSistSvarteRegisterInnsynOperationResponse
  extends ClientOperationResponse {
  InnsynSvarMetadataEntiteter: Array<RegisterInnsynSvarMetadata>;
}
export interface GetHendelsesLoggOperationResponse
  extends ClientOperationResponse {
  Hendelser: Array<LoggHendelse>;
  Antall: number;
}
export interface GetHelseregisterDialogOperationResponse
  extends ClientOperationResponse {
  RegisterDialog: RegisterDialog;
}
export interface UpdateSykdomshistorikkOperationResponse
  extends ClientOperationResponse {}
export interface SearchBehandlingsstedOperationResponse
  extends ClientOperationResponse {
  Behandlingssteder: Array<AdresseValue>;
}
export interface GetVaksinasjonskortOperationResponse
  extends ClientOperationResponse {
  Vaksinasjonskort: Vaksinasjonskort;
}
export interface GetKJActivityLogOperationResponse
  extends ClientOperationResponse {
  AccessLog: Array<KJActivityLogType>;
}
export interface GetGeneralPractitionerOperationResponse
  extends ClientOperationResponse {
  FirstName: string;
  LastName: string;
  MiddleName: string;
...
export interface GetSykdomstyperOperationResponse
  extends ClientOperationResponse {
...
export interface DeleteSykdomshistorikkResponse
  extends ClientOperationResponse {}
export interface UpdateNotificationProfileOperationResponse
  extends ClientOperationResponse {
  Success: boolean;
}
export interface GetNotificationProfileOperationResponse
  extends ClientOperationResponse {
  DailyNotification: boolean;
  MonthlyNotification: boolean;
}
export interface CreateReservationOperationResponse
  extends ClientOperationResponse {
  ReservasjonsDato: ISO8601;
  SlettesDato: ISO8601;
}
export interface GetReservationStatusOperationResponse
  extends ClientOperationResponse {
  ReservasjonsDato: ISO8601;
  SlettesDato: ISO8601;
  ErReservert: boolean;
...
export interface GetHelsepersonellOperationResponse
  extends ClientOperationResponse {
  Helsepersonell: Performer;
}
export interface GetKritiskInformasjonOperationResponse
  extends ClientOperationResponse {
...
export interface GetRFLoggOverBrukOperationResponse
  extends ClientOperationResponse {
  ReseptLoggOverBruk: Array<ReseptLoggOverBruk>;
}
export interface GetKontaktInformationOperationResponse
  extends ClientOperationResponse {
  Information: GetKontaktInformationCommandResult;
}
export interface GetRegisteroppforingOperationResponse
  extends ClientOperationResponse {
  Registre: Array<Register>;
  IsDialogAvailable: boolean;
}
export interface GetJournalDocumentPreviewOperationResponse
  extends PreviewClientOperationResponse {}
export interface DeleteKlageOperationResponse
  extends PasientreiserOperationResponse {
  Succeeded: boolean;
}
export interface GetRFInnholdOperationResponse
  extends LegemidlerOperationResponse {}
export interface GetArchiveDocumentPreviewOperationResult
  extends PreviewClientOperationResponse {}
export interface SaveKlageOperationResponse
  extends PasientreiserOperationResponse {
  Klage: Klage;
}
export interface GenererMineRefleksjonerPreviewOperationResponse
  extends PreviewClientOperationResponse {}
export interface SendKlageOperationResponse
  extends PasientreiserOperationResponse {
  Klage: Klage;
}
export interface GetLegemidlerOperationResponse
  extends LegemidlerOperationResponse {}
export interface CreateKlageOperationResponse
  extends PasientreiserOperationResponse {
  Klage: Klage;
}
...
export interface SetLogOnDialogDoNotAskForConsentCommand
  extends MinHelseCommand {}
...
export interface SetSamtykkekonverteringInformertCommand
  extends MinHelseCommand {}
...
export interface GetPersonvernInnstillingDefinisjonFullstendigTekstCommand
  extends MinHelseCommand {
  PersonvernInnstillingDefinisjonGuid?: any;
  DownloadMode?: boolean;
}
...
export interface PersonverninnstillingGeneriskvisningCommand
  extends MinHelseCommand {}
...
export interface GetBarnMedForeldreSamtykkeInfoCommand
  extends MinHelseCommand {}
...
export interface UpdateKommunikasjonsInnstillingerCommand
  extends MinHelseCommand {
  Kommunikasjon?: KommunikasjonsTyper;
}
export interface GetKommunikasjonsInnstillingerCommand
  extends MinHelseCommand {}
...
export interface RapporterMerknadPaFeilIBesokshistorikkCommand
  extends MinHelseCommand {}
...
export interface HasChangedSocialSecurityNumberCommand
  extends BaseProfileCommand {
  InvalidateCache?: boolean;
}
...
export interface CreateExternalLoggHendelseCommand
  extends CreateLoggHendelseCommand {
...
export interface GetTilgangsloggAnsattInnsynCommand
  extends GetTilgangsloggBaseCommand {
  AnsattId?: string;
  AnsattIdType?: string;
...
export interface GetJournalDocumentPreviewCommand
  extends JournalDocumentCommand {}
export interface GetJournalDocumentCommand extends JournalDocumentCommand {}
export interface DownloadJournalDocumentCommand
  extends JournalDocumentCommand {}
...
export interface GetTilgangsloggInnsynCommand
  extends GetTilgangsloggBaseCommand {}
...
export interface UserGeneratedMessageCommand
  extends UserGeneratedRootMessageCommand {
  ConversationId?: string;
  ParentId?: string;
  MessageId?: string;
  ControlHash?: string;
...
export interface GetConversationsCountCommand
  extends ConversationsQueryCommand {}
...
export interface GetFilteredConversationsCommand
  extends ConversationsQueryCommand {
  ItemsPerPage?: number;
  OrderBy?: any;
  PageNumber?: number;
...
export interface RapporterFeilIBesokshistorikkCommand
  extends UserGeneratedMessageCommand {
...
export interface NewCoordinatorMessageCommand
  extends UserGeneratedMessageCommand {
  CoordinatorType?: CoordinatorType;
  Coordinator?: Person;
}
export interface NewHelsefagligKontaktMessageCommand
  extends UserGeneratedMessageCommand {
...
export interface NewPrimarhelsetjenesteAppointmentCommand
...
export interface CancelAppointmentPrimarhelsetjenesteCommand
  extends AppointmentCommand {
  MessageFunction?: string;
  TransportFormat?: TransportFormat;
  KalenderElementId?: number;
...
export interface RegisterInnsynUtleveringCommand
  extends RegisterDialogBaseCommand {}
export interface RegisterInnsynOpplysningerCommand
  extends RegisterDialogBaseCommand {}
export interface ConfirmEncounterCommand extends BaseEncounterCommand {}
export interface NewHelseregisterMessageCommand
  extends RegisterDialogBaseCommand {}
...
export interface NewStructuredPrescriptionCommand
  extends NewPrescriptionCommand {

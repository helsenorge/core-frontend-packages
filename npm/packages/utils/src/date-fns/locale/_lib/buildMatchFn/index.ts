import { LocaleUnitValue, LocaleWidth, MatchValueCallback, LocaleDayPeriod, Quarter, Era, Day, Month, MatchFn } from 'date-fns';
...
export function buildMatchFn<Value extends LocaleUnitValue, DefaultMatchWidth extends LocaleWidth, DefaultParseWidth extends LocaleWidth>(

import { LocalizeFn, Localize } from 'date-fns';
...
const monthValues = {
  ...
  abbreviated: ['ođđa', 'guov', 'njuk', 'cuo', 'mies', 'geas', 'suoi', 'borg', 'čakč', 'golg', 'skáb', 'juov'] as const,
  wide: [
    'ođđajagemánnu',
    'guovvamánnu',
    'njukčamánnu',
...
const dayValues = {
  ...
  wide: ['sotnabeaivi', 'vuossárga', 'maŋŋebárga', 'gaskavahkku', 'duorastat', 'bearjadat', 'lávvardat'] as const,
};

...
export function usePasientensLegemiddelliste() {
  return HN.Rest.__PasientensLegemiddelliste__ !== undefined &&
    HN.Rest.__PasientensLegemiddelliste__ !== null
    ? HN.Rest.__PasientensLegemiddelliste__
    : false;
}

export function useVerticalUrl() {
  return HN.Rest.__VerticalUrl__ !== undefined &&
    HN.Rest.__VerticalUrl__ !== null
    ? HN.Rest.__VerticalUrl__
    : false;
}

export function isAuthorized() {
  return HN.Rest.__Authorized__ !== undefined && HN.Rest.__Authorized__ !== null
    ? HN.Rest.__Authorized__
    : false;
}

export function hashIsAuthorized() {
  return HN.Rest.__HashIsAuthorized__ !== undefined &&
    HN.Rest.__HashIsAuthorized__ !== null
    ? HN.Rest.__HashIsAuthorized__
    : false;
}

export function useBetaTjeneste() {
  return HN.Rest.__ApiHelseNorgeDisabled__ !== undefined &&
    HN.Rest.__ApiHelseNorgeDisabled__ !== null
    ? !HN.Rest.__ApiHelseNorgeDisabled__
    : false;
}

export function getTjenesteUrl() {
  return HN.Rest.__TjensterUrl__ !== undefined &&
    HN.Rest.__TjensterUrl__ !== null
    ? HN.Rest.__TjensterUrl__
    : "";
}

export function getMinHelseUrl() {
  return HN.Rest.__MinHelseUrl__ !== undefined &&
    HN.Rest.__MinHelseUrl__ !== null
    ? HN.Rest.__MinHelseUrl__
    : "";
}

export function getAssetsUrl() {
  return HN.Page.__Assets__ !== undefined && HN.Page.__Assets__ !== null
    ? HN.Page.__Assets__
    : "";
}
...
export function getPasientreiserUrl() {
  return HN.Rest.__MinHelseUrl__ !== undefined &&
    HN.Rest.__MinHelseUrl__ !== null
    ? `${HN.Rest.__MinHelseUrl__}/pasientreiser`
    : "";
}

export function getHelsenorgeUrl() {
  return HN.Rest.__HelseNorgeUrl__ !== undefined &&
    HN.Rest.__HelseNorgeUrl__ !== null
    ? HN.Rest.__HelseNorgeUrl__
    : "";
}

export function isSkjemautfyller() {
  return (
    HN.Page.__Path__ !== undefined &&
    HN.Page.__Path__ !== null &&
    HN.Page.__Path__ === "skjemautfyller"
  );
}
...
function getAutoPath(): string {
  return isAuthorized() === true
    ? getMinHelseEnvironmentPath()
    : getPortalEnvironmentPath();
}

function canCallAutoService(): boolean {
  return (
    (isAuthorized() === true && hashIsAuthorized() === true) ||
    (isAuthorized() === false && hashIsAuthorized() === false)
  );
}
...
function checkStatus<T extends OperationResponse>(
  response: Response
): Promise<T> | Promise<any> | undefined {
...
export function get<T extends OperationResponse>(
  cmd: string,
  params?: any
): Promise<T> {
  if (!params) {
...
export function getPortal<T extends OperationResponse>(
  cmd: string,
  params?: any
): Promise<T> {
  if (!params) {
...
export function getAuto<T extends OperationResponse>(
  cmd: string,
  params?: {}
): Promise<T> {
  if (canCallAutoService()) {
    ...
    return Promise.resolve(new Response(undefined, { status: 401 })).then(
      checkStatus
    );
  }
}
...
function crud<T extends OperationResponse>(
  method: string,
  cmd: string,
  data?: any,
  params?: any
...
function crudAuto<T extends OperationResponse>(
  method: string,
  cmd: string,
  data?: any,
  params?: any,
  ...
  return fetch(
    (forcePortal ? getPortalEnvironmentPath() : getAutoPath()) +
      cmd +
...
export function postAuto<T extends OperationResponse>(
  cmd: string,
  data?: any,
  params?: any,
  forcePortal?: boolean
...
export function post<T extends OperationResponse>(
  cmd: string,
  data?: any,
  params?: any
): Promise<T> {
...
export function put<T extends OperationResponse>(
  cmd: string,
  data?: any,
  params?: any
): Promise<T> {
...
export function remove<T extends OperationResponse>(
  cmd: string,
  data?: any,
  params?: any
): Promise<T> {
...
export function uploadFile(cmd: string, data: any, params: any): Promise<any> {
  ...
  return fetch(
    getMinHelseEnvironmentPath() + uploadCmd + cmd + parseParams(params, true),
    {
      method: "post",
      credentials: "include",
      cache: "no-cache",
...
export function updateHashValues(
...
export function link(cmd: any, params?: any) {
  return (
    getMinHelseOpenEnvironmentPath() +
    cmd +
    parseParams(addParams(params), true)
  );
}
...
export function download(
  ...
  let url =
    getMinHelseEnvironmentPath() + cmd + parseParams(addParams(params), true);
  const headers = createHeaders();
  headers.set("Content-Type", "multipart/form-data");
            ...
            response = {
              ErrorMessage: {
                Title:
                  ...
                  errorResponse instanceof String
                    ? errorResponse
...
export function getReservasjoner(): Array<Reservasjon> {
  if (
    HN.Commands.__GetTjenesterMedTilgang__ !== undefined &&
    HN.Commands.__GetTjenesterMedTilgang__ !== null
  ) {
    return HN.Commands.__GetTjenesterMedTilgang__.Reservasjoner as Array<
      Reservasjon
    >;
  }

...
const checkStatus = <T extends ProxyOperationResponse>(response: ProxyOperationResponse): Promise<T | null> => {
...
export const get = <T extends ProxyOperationResponse>(url: string, proxyName: string, params?: RequestParamType): Promise<T | null> => {

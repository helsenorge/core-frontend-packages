...
describe('SamtykkeUtil', () => {
  ...
  let samtykker: Array<Samtykke> = [samtykkeDigitaleHelsetjenester as Samtykke, samtykkePasientreiser as Samtykke];
  ...
  let samtykkerOpplysninger: Array<Samtykke> = [samtykkeOpplysninger as Samtykke];

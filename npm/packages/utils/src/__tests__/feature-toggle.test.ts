...
window.HN.Commands.__GetFeatureToggles__ = window.HN.Commands.__GetFeatureToggles__ || {};
window.HN.Commands.__GetFeatureToggles__.FeatureToggles = window.HN.Commands.__GetFeatureToggles__.FeatureToggles || {};
